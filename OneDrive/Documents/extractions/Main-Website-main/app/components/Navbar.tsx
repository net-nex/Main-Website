...
const Navbar = () => {
  ...
  return (
    ...
    <ul className="hidden sm:flex flex-row items-center justify-center">
                <li className="text-white mx-9 py-5"><Link href="/" className="text-3xl">
                NET-NEX
                    </Link></li>
                <li className="text-white mx-9 "><Link href="/events" className="hover:text-b3">EVENTS</Link></li>
                <li className="text-white mx-9 "><Link href="/blogs" className="hover:text-b3">PROJECTS</Link></li>
                <li className="text-white mx-9 "><Link href="/team" className="hover:text-b3">TEAM</Link></li>
                <li className="text-white mx-9 "><Link href="/contact_us" className="hover:text-b3">CONTACT US</Link></li>
            </ul>
            <ul className="flex items-center justify-between sm:hidden">
                <li className="text-white mx-9 text-center py-3"><Link href="/" className="text-3xl">
                    Net-Nex
                    </Link></li>
            ...
            <div className="duration-600 transition-all">
                <ul className="flex sm:hidden flex-col items-center justify-center transition-all ease-in duration-300 ">
                    <li className="text-white mx-9 "><Link href="/events" className="hover:text-b3">events</Link></li>
                    <li className="text-white mx-9 "><Link href="/blogs" className="hover:text-b3">blogs</Link></li>
                    <li className="text-white mx-9 "><Link href="/team" className="hover:text-b3">team</Link></li>
                    <li className="text-white mx-9 "><Link href="/contact_us" className="hover:text-b3">contact us</Link></li>
                </ul>
            </div>
